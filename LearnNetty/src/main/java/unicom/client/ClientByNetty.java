...
public class ClientByNetty {
    ...
    public ClientByNetty() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                WebSocketClientHandler0 handler = (WebSocketClientHandler0) channel.pipeline().get("hookedHandler");
    ...
    public static void main(String[] args) throws Exception {
        ClientByNetty clientByNetty = new ClientByNetty();
